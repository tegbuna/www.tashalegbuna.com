              ...
              <div className="content">
                    <div><p id="quotation-mobile">"A huge passion for front-end development and design... eager to collaborate... add value... committed to continual learning, growth and success."</p></div>
                      ...
                      <div className="paragraphs">
                        ...
                        <div className="two"> <p>In every career prior to software development I have  excelled at connecting with people of all levels.  I  developed a successful portfolio, substantial peer and client networks, and a strong record of advancement and leadership. </p> 
