              ...
              <div className="bio">
                <h2>{title}</h2> 
                    {/* <img className="about-photo" src={Tasha} alt="Tasha L. Egbuna" /> */}
                      ...
                      <p className="para-1"></p>  I'm a full stack software engineer with a huge passion for front-end  development and design.  A few years ago I became curious about coding and that led me to General Assembly's Software Engineering Immersive Program. 
                      <br /><br />
                      ...
                      <br /><span className="centered"><p>I look forward to connecting with you.</p></span>
                      <br />
                      <span className="line"><p></p></span>
                      <br />
                      <span className="email"><p>tasha.egbuna@gmail.com</p></span>
